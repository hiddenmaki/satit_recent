<nav id="sidebar" class="sidebar">
    <div class="sidebar-header d-flex flex-column align-items-center justify-content-center py-4">
        <div class="logo-icon mb-3">
            <img src="assets/images/logo.png" alt="Satit School Logo" class="img-fluid rounded-circle shadow-sm" style="max-width: 80px; border: 3px solid rgba(255,255,255,0.2);">
        </div>
    ...
    <ul class="list-unstyled components mb-5">
        ...
        <li>
            <a href="#masterSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                <i class="fas fa-database me-3"></i><span class="sidebar-text">ข้อมูลพื้นฐาน</span>
            </a>
            <ul class="collapse list-unstyled sub-menu" id="masterSubmenu">
                <li><a href="master-teacher.php" class="nav-link"><i class="fas fa-chalkboard-teacher me-2"></i>ข้อมูลครู</a></li>
                <li><a href="master-student.php" class="nav-link"><i class="fas fa-user-graduate me-2"></i>ข้อมูลนักเรียน</a></li>
                <li><a href="master-subject.php" class="nav-link"><i class="fas fa-book me-2"></i>ข้อมูลรายวิชา</a></li>
                <li><a href="master-class.php" class="nav-link"><i class="fas fa-layer-group me-2"></i>ข้อมูลระดับชั้น</a></li>
                <li><a href="master-classroom.php" class="nav-link"><i class="fas fa-door-open me-2"></i>ข้อมูลห้องเรียน</a></li>
            </ul>
        </li>
        <?php endif; ?>
