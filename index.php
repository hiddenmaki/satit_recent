...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-primary btn-sm" style="background-color: var(--accent-color); border: none;"><i class="fas fa-calendar-day me-1"></i> วันนี้: <?= date('d/m/Y') ?></button>
    </div>
</div>
        ...
        <div class="card stat-card h-100 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="fw-bold mb-0 text-primary"><?= htmlspecialchars($stu['level_name'] . '/' . $stu['room_name']) ?></h3>
                </div>
                <div class="stat-icon bg-primary-light">
                    <i class="fas fa-door-open"></i>
                </div>
                            ...
                            <?php if (!empty($todaySchedules)): ?>
                                <?php foreach($todaySchedules as $sc): ?>
                                 <tr>
                                     ...
                                     <td><div class="fw-medium"><?= htmlspecialchars($sc['subject_code'] . ' ' . $sc['subject_name']) ?></div></td>
            ...
            pie: {
                donut: {
                    ...
                    labels: {
                        ...
                        total: { show: true, label: 'ทั้งหมด', formatter: function (w) { 
